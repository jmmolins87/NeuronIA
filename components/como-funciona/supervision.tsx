...
import { Eye, UserCheck, Shield, MessageSquare } from "lucide-react"
import { useTranslation } from "@/components/providers/i18n-provider"

const icons = [Eye, UserCheck, Shield, MessageSquare]
      ...
      {items.map((item, index) => {
        ...
        return (
          <li
            key={index}
            data-stagger-item
            className="group relative rounded-xl border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-accent/10 dark:from-primary/20 dark:to-accent/20 backdrop-blur-sm p-6 transition-all hover:border-primary hover:shadow-2xl dark:hover:shadow-primary/20"
          >
