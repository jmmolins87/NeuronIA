...
export default function NotFound() {
  ...
  return (
    <Section
      variant="alt"
      className="home-reflections home-surface-final home-shadow-final min-h-screen flex items-center justify-center py-20 overflow-x-hidden"
    >
      <div className="container relative z-10 mx-auto max-w-4xl px-4">
        <div className="relative z-20 text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-foreground">{t("notFound.heading")}</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            <DemoButton onClick={() => router.back()} className="min-w-[200px]">
